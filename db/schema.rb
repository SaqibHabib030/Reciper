...
ActiveRecord::Schema.define(version: 2022_02_23_140758) do
  ...
  create_table "recipy_ingredients", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "unit"
    t.float "quantity"
    ...
    t.index ["recipe_id"], name: "index_recipy_ingredients_on_recipe_id"
